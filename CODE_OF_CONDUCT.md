...
This project processes clinical-note text. Even though the bundled dataset is synthetic, treat all
note content as if it were real NHS PHI: never paste note text into issues, pull requests, or chat —
reference file paths instead, and never commit anything under `data/` or `outputs/`.
...
maintainers by opening a confidential issue or contacting the repository owner on GitHub
